          ...
          <section class="invoice" >
            ...
            <div class="row">
              <div class="col-xs-12">
                <h2 class="page-header">
                  ...
                  <small class="pull-right"> {!! $orders->created_at !!}</small>
                </h2>
              </div>
              <!-- /.col -->
            </div>
            ...
            <div class="row invoice-info">
              ...
              <div class="col-sm-4 invoice-col">
                To
                <address>
                  <strong>{!! $orders->bills->customers->name !!}</strong><br>
                  {!! $orders->bills->customers->address !!}<br>
                  Phone: {!! $orders->bills->customers->phone !!}<br>
                </address>
              </div>
              <!-- /.col -->
              <div class="col-sm-4 invoice-col">
                <b>Invoice #{!! $orders->bills->code !!}</b><br>
                <br>
            ...
            <div class="row">
              <div class="col-xs-12 table-responsive">
                <table class="table table-striped table-bordered">
                  ...
                  <tbody>
                        @foreach($order_detaisl as $orderdetaisl)
                  <tr>
                    <td>{!! $orderdetaisl->items->code !!}</td>
                    <td>{!! $orderdetaisl->items->name !!}</td>
                    <td>{!! $orderdetaisl->units->name !!}</td>
                    <td>{!! $orderdetaisl->qty !!}</td>
            ...
            <div class="row">
              ...
              <!-- /.col -->
              <div class="col-xs-6">
                <p class="lead"> Due {!! $orders->order_date !!}</p>
        
                <div class="table-responsive">
                  <table class="table">
                    <tbody><tr>
                      <th style="width:50%">Recipient signature:</th>
                      <td>............................</td>
                    </tr>
                    <tr>
                      <th>Dispatcher signature:</th>
                      <td>............................</td>
                    </tr>
